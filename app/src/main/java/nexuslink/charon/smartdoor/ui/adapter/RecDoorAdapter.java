...
public class RecDoorAdapter extends RecyclerView.Adapter {
    ...
    public RecDoorAdapter( Context mContext,List<MainModel.ItemModel> list ,MainContract.View mainView) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MyViewHolder)holder).mRl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mainView.translationDoor(x,y,width,height,list.get(position).getImg());
            }
        });
    }
